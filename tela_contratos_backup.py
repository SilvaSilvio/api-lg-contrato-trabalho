                                ...
                                ft.Row(
                                    [
                                        ft.IconButton(
                                            ...
                                            tooltip="Editar",
                                            on_click=lambda e, u=user["username"]: self.editar_usuario(u)
                                        ),
                                        ft.IconButton(
                                            icon=ft.icons.DELETE,
                                            icon_color=ft.colors.RED_400,
                                            tooltip="Excluir",
                                            on_click=lambda e, u=user["username"]: self.excluir_usuario(u)
                                        )
                                    ]
                                )
                            )
                                ...
                                ft.Row(
                                    [
                                        ft.IconButton(
                                            ...
                                            tooltip="Editar",
                                            data=emp["codigo"],
                                            on_click=lambda e: editar_empresa(e.control.data)
                                        ),
                                        ft.IconButton(
                                            icon=ft.icons.DELETE,
                                            icon_color=ft.colors.RED_400,
                                            tooltip="Excluir",
                                            data=emp["codigo"],
                                            on_click=lambda e: excluir_empresa(e.control.data)
                                        )
                                    ]
                                )
                            )
